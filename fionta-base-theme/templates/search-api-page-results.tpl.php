...
<div class="<?php print $classes;?>">
  ...
  <?php if ($result_count): ?>
    <p class="search-api-result-count"><?php print t('Your search returned ') . $result_count . t(' results. Use the filters on the right side of the page to limit the results.'); ?></p>
